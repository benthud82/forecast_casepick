...
sqlquery <- paste("SELECT 
                  ...
                  AND predicted_availhour BETWEEN 6 AND 16
...
rmse.lm
plot(dataTest$BOXES,prediction.lm,col='blue',main='Real vs predicted Random Forest',pch=18, cex=0.7)
...
rmse.dt
 plot(dataTest$BOXES,prediction.dt,col='blue',main='Real vs predicted Random Forest',pch=18, cex=0.7)
...
nn <- neuralnet(f,data=scaled_train,hidden=c(5),linear.output=F)
...
rmse.nn
 ...
 plot(dataTest$BOXES,pr.nn_,col='blue',main='Real vs predicted Random Forest',pch=18, cex=0.7)
 abline(0,1,lwd=2)
