...
<div style="margin-bottom:100px; font-family:calibri;">
...
The measuring statistics will be root mean squared error (RMSE).
</div>


```{r echo=TRUE, message=FALSE, warning=FALSE}
knitr::opts_chunk$set(message = FALSE)
packages <- c('useful', 'coefplot', 'xgboost', 'here', 'magrittr', 'dygraphs', 'dplyr', 'RMySQL', 'caret', 'purrr', 'randomForest', 'rpart', 'neuralnet', 'tictoc', 'tinytex', 'DT')
